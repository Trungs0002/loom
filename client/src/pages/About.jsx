      ...
      <section className="relative w-full min-h-[50vh] flex items-center overflow-hidden bg-primary text-on-primary">
        <div className="absolute inset-0 z-0 opacity-40">
          <img
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAaPYMaiQe0s4wgYylHTX3to9okdYtXdfgL5DEFpiNSIL6WJ2x3SkYnsnYGE_DUCbHaf9ejPgD1DL5kmDz5wCx9af7mJe18jcFDyxhkCPNeMfOeyZ1QDob6ODHDqvbsD9_tYaWRRgL8s9UgB47aSbivKhZlfC1501SaTaUCk3qbkcCWbzZ_pRqZnRtBW2utMKT-S25X3C3COHOG6ETOLiMu9m96bdQRQOfIIxA3ci5688YTOJhR9XveHYJpYxEcN3ukyfB57llzmpU"
          />
        </div>
        <div className="relative z-10 w-full max-w-container-max mx-auto px-gutter py-xxl text-center">
          <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg mb-md">Our Story</h1>
          <p className="font-body-lg text-body-lg max-w-2xl mx-auto opacity-90">
            Loom was founded on the belief that luxury should not come at the cost of our planet. We redefine elegance through sustainable innovation.
          </p>
        </div>
      </section>
      ...
      <section className="w-full max-w-container-max mx-auto px-gutter py-xxl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-xxl items-center">
          <div>
            ...
            <h2 className="font-headline-lg text-headline-lg text-primary mb-lg tracking-tight">Elegance with a Purpose</h2>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-md">
              At Loom, we don't just make bags; we create symbols of change. Our mission is to eliminate the concept of "waste" by transforming discarded materials into high-end fashion staples.
            </p>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              Every design is born from a desire for minimalism and a commitment to longevity. We believe in buying less but buying better—pieces that stand the test of time both in quality and style.
            </p>
          </div>
      ...
      <section className="w-full max-w-container-max mx-auto px-gutter py-xxl">
        <div className="bg-primary text-on-primary rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row">
          <div className="lg:w-1/2 p-xl md:p-xxl flex flex-col justify-center">
            ...
            <h2 className="font-display-md text-display-md mb-lg">Recycled Denim: Our Signature</h2>
            <p className="font-body-lg text-body-lg opacity-90 mb-xl leading-relaxed">
              We specialize in transforming vintage denim and post-consumer textile waste into premium fabrics. This process saves thousands of gallons of water and prevents tons of fabric from reaching landfills.
            </p>
          ...
          <div className="lg:w-1/2 min-h-[400px]">
            <img 
              ...
              className="w-full h-full object-cover"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAhnk20scGCchHeulXPn_48JVAc_YrBf_XDGsn9LyynbXqXDDpcSPjtTBXcA5Ja2gB2DM2_ZPHc8P8YIyma5XbKy03N7XcLGvDidbfPux776krFzT1icHOOx3r_oh1G8DsUR28pZ71vG1at6HSmBUIwUBdfJLCgWJRzVsYqJOHMV7aFKscZZv7w3RkeI94XIIhn1ihlPvl4CRiXIxteib5FB_9Wd-x9echkbLlmGJplZHdt-TkJgcKTN0VeihaJtN2j45bmco687Fw" 
            />
          </div>
        </div>
      </section>
